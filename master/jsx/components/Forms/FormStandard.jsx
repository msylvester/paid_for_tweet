                        ...
                        <Panel header="Stacked form">
                            <form role="form">
                                <FormGroup>
                                    ...
                                    <FormControl standalone type="email" placeholder="Enter email" className="form-control" />
                                </FormGroup>
                                <FormGroup>
                                    <label>Password</label>
                                    <FormControl standalone type="password" placeholder="Password" className="form-control" />
                                </FormGroup>
                                <div className="checkbox c-checkbox">
                                    <label>
                        ...
                        <Panel header="Horizontal form">
                            <form className="form-horizontal">
                                <FormGroup>
                                    ...
                                    <Col lg={ 10 }>
                                        <FormControl standalone type="email" placeholder="Email" className="form-control" />
                                    </Col>
                                </FormGroup>
                                <FormGroup>
                    ...
                    <form method="get" action="/" className="form-horizontal">
                        <fieldset>
                            ...
                            <FormGroup>
                                ...
                                <Col sm={ 10 }>
                                    <FormControl standalone type="text" className="form-control form-control-rounded" />
                                </Col>
                            </FormGroup>
                        </fieldset>
                        <fieldset>
                            <FormGroup>
                                ...
                                <Col sm={ 10 }>
                                    <FormControl standalone type="text" className="form-control" />
                        ...
                        <fieldset>
                            <FormGroup>
                                ...
                                <Col sm={ 10 }>
                                    <FormControl standalone id="input-id-1" type="text" className="form-control" />
                                </Col>
                            </FormGroup>
                        </fieldset>
                        <fieldset>
                            <FormGroup>
                                ...
                                <Col sm={ 10 }>
                                    <FormControl standalone type="password" name="password" className="form-control" />
                                </Col>
                            </FormGroup>
                        </fieldset>
                        <fieldset>
                            <FormGroup>
                                ...
                                <Col sm={ 10 }>
                                    <FormControl standalone type="text" placeholder="placeholder" className="form-control" />
                                </Col>
                            </FormGroup>
                        </fieldset>
                        <fieldset>
                            <FormGroup>
                                ...
                                <Col lg={ 10 }>
                                    <FormControl standalone type="text" placeholder="Disabled input here..." disabled className="form-control" />
                                </Col>
                            </FormGroup>
                        </fieldset>
                        <fieldset>
                        ...
                        <fieldset className="last-child">
                            <FormGroup>
                                ...
                                <Col sm={ 10 }>
                                    <FormControl standalone componentClass="select" name="account" className="form-control m-b">
                                    ...
                                    <Row>
                                        <div className="col-lg-4">
                                            <FormControl standalone componentClass="select" multiple="" className="form-control">
                                                <option>Option 1</option>
                                                <option>Option 2</option>
                                                <option>Option 3</option>
                                                <option>Option 4</option>
                        ...
                        <fieldset>
                            <FormGroup>
                                ...
                                <Col sm={ 10 }>
                                    <FormControl standalone type="text" placeholder=".input-lg" className="form-control input-lg m-b" />
                                    <br/>
                                    <FormControl standalone type="text" placeholder="Default input" className="form-control m-b" />
                                    <br/>
                                    <FormControl standalone type="text" placeholder=".input-sm" className="form-control input-sm" />
                                </Col>
                            </FormGroup>
                        </fieldset>
                        <fieldset>
                                ...
                                <Col sm={ 10 }>
                                    <Row>
                                        <div className="col-md-2">
                                            <FormControl standalone type="text" standalone placeholder=".col-md-2" className="form-control" />
                                        </div>
                                        <div className="col-md-3">
                                            <FormControl standalone type="text" standalone placeholder=".col-md-3" className="form-control" />
                                        </div>
                                        <div className="col-md-4">
                                            <FormControl standalone type="text" standalone placeholder=".col-md-4" className="form-control" />
                                        </div>
                                    </Row>
                                </Col>
                            </FormGroup>
