                               ...
                               <Panel header="2. Billing Information" eventKey="2">
                                        ...
                                        <div className="mv">
                                           <div className="radio c-radio">
                                              <label>
                                                 <input id="chk-guest" type="radio" name="checkout-ship-to" defaulValue="address" />
                                                 <em className="fa fa-check"></em>Ship to this address</label>
                                           </div>
                                           <div className="radio c-radio">
                                              <label>
                                                 <input id="chk-guest" type="radio" name="checkout-ship-to" defaulValue="other" />
                                           ...
                                           <tbody>
                                              <tr>
                                                 <td>
                                                    <div className="radio c-radio">
                                                       <label>
                                                          <input id="chk-guest" type="radio" name="checkout-ship" defaulValue="free" />
                                              ...
                                              <tr>
                                                 <td>
                                                    <div className="radio c-radio">
                                                       <label>
                                                          <input id="chk-guest" type="radio" name="checkout-ship" defaulValue="std" />
                                                          <em className="fa fa-check"></em>
                                                       </label>
                                                    </div>
                                                 </td>
                                              ...
                                              <tr>
                                                 <td>
                                                    <div className="radio c-radio">
                                                       <label>
                                                          <input id="chk-guest" type="radio" name="checkout-ship" defaulValue="next" />
                                                          <em className="fa fa-check"></em>
                                                       </label>
                                                    </div>
                                                 </td>
                                        ...
                                        <div className="row">
                                           <div className="col-lg-6">
                                              <div className="form-group">
                                                 <div className="radio c-radio">
                                                    <label>
                                                       <input id="chk-guest" type="radio" name="checkout-pay" defaulValue="paypal" defaultChecked className="form-control" />
                                              ...
                                              <div className="form-group">
                                                 <div className="radio c-radio">
                                                    <label>
                                                       <input id="chk-guest" type="radio" name="checkout-pay" defaulValue="check" className="form-control" />
                                              ...
                                              <div className="form-group">
                                                 <div className="radio c-radio">
                                                    <label>
                                                       <input id="chk-guest" type="radio" name="checkout-pay" defaulValue="creditcard" className="form-control" />
                                              ...
                                              <div className="form-group">
                                                 ...
                                                 <select name="checkout-cc-type" required="" className="form-control">
                                                    <option defaulValue="">- Please Select -</option>
                                                    <option defaulValue="amex">American Express</option>
                                                    <option defaulValue="visa">Visa</option>
                                                    <option defaulValue="master">Mastercard</option>
                                                 </select>
                                              </div>
                                              <div className="form-group">
                                                 ...
                                                 <div className="col-lg-5">
                                                    <div className="form-group">
                                                       ...
                                                       <select name="checkout-cc-exp-month" required="" className="form-control">
                                                          <option defaulValue="">Month</option>
                                                          <option defaulValue="1">January</option>
                                                          <option defaulValue="2">February</option>
                                                          <option defaulValue="3">March</option>
                                                          <option defaulValue="4">April</option>
                                                          <option defaulValue="5">May</option>
                                                          <option defaulValue="6">June</option>
                                                          <option defaulValue="7">Jule</option>
                                                          <option defaulValue="8">August</option>
                                                          <option defaulValue="9">September</option>
                                                          <option defaulValue="10">October</option>
                                                          <option defaulValue="11">November</option>
                                                          <option defaulValue="12">December</option>
                                                       </select>
                                                    </div>
                                                 </div>
                                                 <div className="col-lg-5">
                                                    <div className="form-group">
                                                       ...
                                                       <select name="checkout-cc-exp-year" required="" className="form-control">
                                                          <option defaulValue="">Year</option>
                                                          <option defaulValue="2016">2016</option>
                                                          <option defaulValue="2017">2017</option>
                                                          <option defaulValue="2018">2018</option>
                                                          <option defaulValue="2019">2019</option>
                                                          <option defaulValue="2020">2020</option>
                                                          <option defaulValue="2021">2021</option>
                                                          <option defaulValue="2022">2022</option>
                                                          <option defaulValue="2023">2023</option>
                                                       </select>
                                                    </div>
                                                 </div>
                                              ...
                                              <tbody>
                                                 <tr>
                                                    ...
                                                    <td className="order-qty">
                                                       <input type="text" name="checkout-qty" defaulValue="1" className="form-control" />
                                                    </td>
